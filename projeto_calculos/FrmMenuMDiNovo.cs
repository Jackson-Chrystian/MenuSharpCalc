...
namespace projeto_calculos
{
    public partial class FrmMenuMDiNovo : Form
    {
        ...
        {
            FmrSuper objCalc = new FmrSuper(); //Inatancia a classe 
            objCalc.MdiParent = this;
            objCalc.Show();
        }
        ...
        private void comRadioButonsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            FrmCalcRadio objCal = new FrmCalcRadio();
            objCal.MdiParent = this;
            objCal.Show();
        }
    }
}
